...
function AtlasLootDefaultFrame_SelectLootTable()
    ...
    if (AtlasLootOptions["SelectedType"] == 1) or (AtlasLootOptions["SelectedType"] == 2) or (AtlasLootOptions["SelectedType"] == 3) then
        ...
        if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]~="" then
            AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
        else
            local index = AtlasLootOptions["SelectedZoneText"];
            if AtlasLoot_Bosses[index] then
    ...
    elseif AtlasLootOptions["SelectedType"] == 4 then
        local index = AtlasLootOptions["SelectedZone"];
        AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootWBItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
    elseif AtlasLootOptions["SelectedType"] == 5 then
        local index = AtlasLootOptions["SelectedZone"];
        if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]~="" then
            AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootSetItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
        else
    ...
    elseif AtlasLootOptions["SelectedType"] == 6 then
        local index = AtlasLootOptions["SelectedZone"];
        if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]~="" then
            if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2] == "AQBroodRings" then
                AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
            else
                AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootRepItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
            end
        else
            local i1 = AtlasLootOptions["SelectedZoneText"];
            local i2 = AtlasLootOptions["SelectedBoss"];
    ...
    elseif AtlasLootOptions["SelectedType"] == 7 then
        ...
        if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]~="" then
            if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2] == "AQBroodRings" then
                ...
                AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootProfessionsItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
            end
        else
            local i1 = AtlasLootOptions["SelectedZoneText"];
            local i2 = AtlasLootOptions["SelectedBoss"];
            if AtlasLoot_Bosses[i1] then
				ChatFrame1:AddMessage("wert="..AtlasLoot_Bosses[i1][i2][2], 255, 255, 255, 0, 0);
                AtlasLoot_ShowItemsFrame(AtlasLoot_Bosses[i1][i2][2], AtlasLootProfessionsItems, AtlasLoot_Bosses[i1][i2][1], pFrame);
            end
        end
    elseif AtlasLootOptions["SelectedType"] == 8 then
        local index = AtlasLootOptions["SelectedZoneText"];
        if AtlasLoot_Bosses[index] then
            local subindex = AtlasLootOptions["SelectedBoss"];
            if AtlasLootSetItems[AtlasLoot_Bosses[index][subindex][2]] then --PvP Set exception
            ...
            if AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]~="" then
                if AtlasLootBGItems[AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2]] then
                    AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootBGItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
                else
                    AtlasLoot_ShowItemsFrame(AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][2], AtlasLootWorldPvPItems, AtlasLoot_Zones[AtlasLootOptions["SelectedType"]][index][1], pFrame);
                end
            end
        end
    end
