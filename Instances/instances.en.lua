...
AtlasLootItems = {
	...
	BWLVaelastrasz = {
		...
		{ 0,"","","" },
		{ 0,"","","" },
		{ 19339, "Spell_Nature_WispHeal", "=q4=Mind Quickening Gem", "=q1=#m1# =ds=#c3#, =ds=#s14#", "18.96%" },
	...
	MCMajordomo = {
        ...
        { 18713, "INV_Weapon_Bow_01", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m1# =ds=#c2#, #w2#" },
    ...
    AQ20Andorov = {
		...
		{ 0,"","","" },
        { 0,"","","" },
        { 22191, "INV_Chest_Chain_17", "=q4=Obsidian Mail Tunic", "=ds=#a3# #s5#" },
    ...
    AQ40Emperors = {
        ...
        { 20735, "INV_Misc_Note_01", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#p4#", "6.62%" },
        ...
        { 20726, "INV_Misc_Note_01", "=q3=Formula: Enchant Gloves - Threat", "=ds=#p4#", "6.24%" },
    ...
    AQOpening = {
        ...
        { 21530, "INV_Pants_Mail_04", "=q4=Onyx Embedded Leggings", "=ds=#a3# #s11#" },
        { 21529, "INV_Jewelry_Necklace_17", "=q4=Amulet of Shadow Shielding", "=ds=#s2#" },
        { 0, "", "", "" },
        { 0, "INV_Misc_Gem_Emerald_03", "=q6="..ATLASLOOT_GREEN_SCEPTER, "" },
        { 21532, "INV_Boots_08", "=q4=Drudge Boots", "=ds=#a2# #s12#" },
        { 21531, "INV_Jewelry_Necklace_22", "=q4=Drake Tooth Necklace", "=ds=#s2#" },
        { 0, "", "", "" },
        { 0, "INV_Misc_Gem_Sapphire_03", "=q6="..ATLASLOOT_BLUE_SCEPTER, "" },
        { 21517, "INV_Helmet_63", "=q4=Gnomish Turban of Psychic Might", "=ds=#a1# #s1#" },
        { 21527, "INV_Chest_Cloth_31", "=q4=Darkwater Robes", "=ds=#a1# #s5#" },
        { 21526, "INV_Jewelry_Ring_35", "=q4=Band of Icy Depths", "=ds=#s13#" },
        { 21025, "INV_Misc_Book_02", "=q4=Recipe: Dirge's Kickin' Chimaerok Chops", "=ds=#p3#" },
        { 0, "", "", "" },
        { 0, "", "", "" },
    ...
    BFDTrash = {
        ...
        { 2271, "INV_Staff_31", "=q3=Staff of the Blessed Seer", "=ds=#h2#, #w9#", "0.02%" },
        ...
        { 3415, "INV_Staff_32", "=q3=Staff of the Friar", "=ds=#h2#, #w9#", "0.02%" },
   ...
   WCDeviateFaerieDragon = {
    ...
    STTrash = {
        { 10627, "INV_Staff_28", "=q3=Bludgeon of the Grinning Dog", "=ds=#h2#, #w9#", "0.02%" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 16216, "INV_Misc_Note_01", "=q2=Formula: Enchant Cloak - Greater Resistance", "=ds=#p4# #m17# =q6=(Atal'ai Witch Doctor)", "0.75%" },
        { 15733, "INV_Scroll_03", "=q3=Pattern: Green Dragonscale Leggings", "=ds=#p7# (270) =q6=(Murk Worm)", "1.80%" },
    ...
    ZFTrash = {
        ...
        { 9480, "INV_Spear_05", "=q3=Eyegouger", "=ds=#h2#, #w7#", "0.01%" },
        { 9483, "INV_Torch_Lit", "=q3=Flaming Incinerator", "=ds=#w12#", "0.01%" },
        { 5616, "INV_Sword_31", "=q3=Gutwrencher", "=ds=#h1#, #w4#", "0.01%" },
        {  862, "INV_Belt_34", "=q3=Runed Ring", "=ds=#s13# =q2=(has random enchantment)", "0.02%" },
        ...
        { 9482, "INV_Staff_31", "=q3=Witch Doctor's Cane", "=ds=#h2#, #w9#", "0.01%" },
        };
    ...
    RFDTrash = {
        ...
        { 10572, "INV_Wand_01", "=q3=Freezing Shard", "=ds=#w12#, =q2=#c3#", "0.01%" },
    ...
    UldTrash = {
        ...
        { 9432, "INV_Bracer_14", "=q3=", "=ds=#s8#, #a4#", "0.01%" },
        ...
        { 9428, "INV_Bracer_06", "=q3=Unearthed Bands", "=ds=#s8#, #a2# =q2=(has random enchantment)", "0.01%" },
        };
    ...
    SMTrash = {
        { 7682, "INV_Spear_01", "=q3=Torturing Poker", "=ds=#h1#, #w4# =q2=#x39#", "5.56%" },
        { 0,"","","" },
        ...
        { 7758, "INV_Spear_08", "=q3=Ruthless Shiv", "=ds=#h2#, #w7#", "0.00%" },
        ...
        { 7757, "INV_Wand_07", "=q3=Windweaver Staff", "=ds=#h2#, #w9#", "0.01%" },
        };
    ...
    RFKTrash = {
        ...
        { 2549, "INV_Staff_25", "=q3=Staff of the Shade", "=ds=#h2#, #w9#", "0.02%" },
    ...
    BRDArena = {
        ...
        { 11729, "INV_Helmet_01", "=q3=Savage Gladiator Helm", "=ds=#s1#, #a3# =q2=#brd3#", "10.08%" },
        ...
        { 11610, "INV_Scroll_03", "=q3=Plans: Dark Iron Pulverizer", "=ds=#p2# #m17# =q2=#brd4#", "69.76%" },
    ...
    BRDGuzzler = {
        ...
        { 12793, "INV_Chest_Leather_01", "=q3=Mixologist's Tunic", "=ds=#a2#, #s5#", "24.87%" },
    ...
    BRDTrash = {
        ...
        { 15781, "INV_Scroll_05", "=q3=Pattern: Black Dragonscale Leggings", "=ds=#p7# #m14#", "1.93%" },
        { 15770, "INV_Scroll_03", "=q3=Pattern: Black Dragonscale Shoulders", "=ds=#p7# #m14#", "1.88%" },
        { 12532, "INV_Wand_07", "=q3=Spire of the Stoneshaper", "=ds=#h2#, #w9#", "0.01%" },
        ...
        { 12527, "INV_Axe_13", "=q3=Ribsplitter", "=ds=#h3#, #w1# =q2=(has random enchantment)", "0.02%" },
        ...
        { 11606, "INV_Chest_Chain_16", "=q2=Dark Iron Mail", "=ds=#s5#, #a3#" },
        { 11615, "INV_Scroll_06", "=q2=Plans: Dark Iron Shoulders", "=ds=#p2# (280)", "7.65%" },
        { 11605, "INV_Shoulder_09", "=q2=Dark Iron Shoulders", "=ds=#s3#, #a4#" },
        { 16049, "INV_Scroll_06", "=q2=Schematic: Dark Iron Bomb", "=ds=#p5# #m20#", "1.02%" },
        { 16048, "INV_Scroll_06", "=q2=Schematic: Dark Iron Rifle", "=ds=#p5# #m16#", "0.98%" },
        { 18654, "INV_Scroll_06", "=q2=Schematic: Gnomish Alarm-O-Bot", "=ds=#p5# #m17#", "1.88%" },
        { 16053, "INV_Scroll_06", "=q2=Schematic: Master Engineer's Goggles", "=ds=#p5# #m18#", "0.45%" },
        { 18661, "INV_Scroll_06", "=q2=Schematic: World Enlarger", "=ds=#p5# (260)", "2.00%" },
        };
...
-- deathsworn captain (rare spawn)
        ...
        { 1484, "INV_Wand_04", "=q3=Witching Stave", "=ds=#h2#, #w9#", "0.01%" },
        ...
        { 0, "", "", "" },
        { 0, "", "", "" },
        { 0, "INV_Box_01", "=q6=Fel Steed/Shadow Charger", "" },
        { 6341, "INV_Misc_Lantern_01", "=q2=Eerie Stable Lantern", "=ds=#s15#", "5.48%" },
        { 0, "", "", "" },
        { 0, "INV_Box_01", "=q6=Deathsworn Captain (rare)", "" },
    ...
    DMETrash = {
        ...
        { 18295, "INV_Boots_06", "=q3=Phasing Boots", "=ds=#s12#, #a1# =q2=(has random enchantment)", "1.26%" },
        };
    ...
    UBRSTrash = {
        { 24102, "INV_Misc_Book_14", "=q3=Manual of Eviscerate IX", "=ds=#e20#", "0.94%" },
        { 13260, "INV_Boots_01", "=q3=Wind Dancer Boots", "=ds=#s12#, #a3#", "0.01%" },
        { 0,"","","" },
        { 16247, "INV_Misc_Note_01", "=q2=Formula: Enchant 2H Weapon - Superior Impact", "=ds=#p4# #m15#", "1.54%" },
        };
    ...
    STRATTrash = {
        { 16681, "INV_Bracer_17", "=q3=Beaststalker's Bindings", "=ds=#s8#, #a3#", "1.64%" },
        { 16736, "INV_Belt_34", "=q3=Belt of Valor", "=ds=#s10#, #a4#", "2.02%" },
        { 16671, "INV_Bracer_02", "=q3=Bindings of Elements", "=ds=#s8#, #a3#", "1.90%" },
        { 18781, "INV_Misc_Note_03", "=q3=Bottom Half of Advanced Armorsmithing: Volume II", "=ds=#m3#", "44.87%" },
        { 18783, "INV_Misc_Note_04", "=q3=Bottom Half of Advanced Armorsmithing: Volume III", "=ds=#m3#", "32.24%" },
        { 16697, "INV_Belt_31", "=q3=Devout Bracers", "=ds=#s8#, #a1#", "1.15%" },
        { 16702, "INV_Belt_12", "=q3=Dreadmist Belt", "=ds=#s10#, #a1#", "0.90%" },
        { 18743, "INV_Misc_Cape_18", "=q3=Gracious Cape", "=ds=#s4#", "0.01%" },
        { 17061, "INV_Misc_Cape_20", "=q3=Juno's Shadow", "=ds=#s4#", "0.01%" },
        { 16723, "INV_Belt_11", "=q3=Lightforge Belt", "=ds=#s10#, #a4#", "1.83%" },
        { 16685, "INV_Belt_08", "=q3=Magister's Belt", "=ds=#s10#, #a1#", "0.80%" },
        ...
        { 16714, "INV_Bracer_09", "=q3=Wildheart Bracers", "=ds=#s8#, #a2#", "1.49%" },
        { 0,"","","" },
        { 16248, "INV_Misc_Note_01", "=q2=Formula: Enchant Weapon - Unholy", "=ds=#p4# #m15#", "0.36%" },
        { 16249, "INV_Misc_Note_01", "=q2=Formula: Enchant 2H Weapon - Major Intellect", "=ds=#p4# #m14#", "1.19%" },
        { 15768, "INV_Scroll_06", "=q2=Pattern: Wicked Leather Belt", "=ds=#p7# #m14#", "0.85%" },
        { 15777, "INV_Scroll_06", "=q2=Pattern: Runic Leather Shoulders", "=ds=#p7# #m14#", "1.00%" },
        { 14495, "INV_Scroll_06", "=q2=Pattern: Ghostweave Pants", "=ds=#p8# #m18#", "2.13%" },
        { 16052, "INV_Scroll_06", "=q2=Schematic: Voice Amplification Modulator", "=ds=#p5# #m18#", "1.99%" },
        { 18658, "INV_Scroll_06", "=q2=Schematic: Ultra-Flash Shadow Reflector", "=ds=#p5# #m14#", "1.82%" },
        { 12827, "INV_Scroll_06", "=q2=Plans: Serenity", "=ds=#p2# #m20#", "10.77%" },
        { 12830, "INV_Scroll_03", "=q1=Plans: Corruption", "=ds=#p2# #m18#", "14.32%" },
        };
    ...
    LBRSTrash = {
        { 13181, "INV_Gauntlets_15", "=q3=Demonskin Gloves", "=ds=#s9#, #a1#", "15.88%" },
        { 13182, "INV_Sword_36", "=q3=Phase Blade", "=ds=#h1#, #w10#", "11.63%" },
        { 0, "", "", "" },
        { 14513, "INV_Scroll_03", "=q4=Pattern: Robe of the Archmage", "=ds=#p8# #m14#", "10.12%" },
        { 14152, "INV_Chest_Cloth_38", "=q4=Robe of the Archmage", "=ds=#s5#, #a1#" },
        { 15749, "INV_Scroll_06", "=q2=Pattern: Volcanic Breastplate", "=ds=#p7# #m20#", "2.04%" },
        { 15053, "INV_Chest_Leather_07", "=q2=Volcanic Breastplate", "=ds=#s5#, #a2#" },
        { 15775, "INV_Scroll_06", "=q2=Pattern: Volcanic Shoulders", "=ds=#p7# #m14#", "10.56%" },
        { 15055, "INV_Shoulder_13", "=q2=Volcanic Shoulders", "=ds=#s3#, #a2#" },
        { 13494, "INV_Scroll_06", "=q2=Recipe: Greater Fire Protection Potion", "=ds=#p1# #m18#", "1.94%" },
        { 16250, "INV_Misc_Note_01", "=q2=Formula: Enchant Weapon - Superior Striking", "=ds=#p4# #m14#", "1.04%" },
        { 16244, "INV_Misc_Note_01", "=q2=Formula: Enchant Gloves - Greater Strength", "=ds=#p4# #m15#", "4.16%" },
        };
    ...
    SCHOLOTrash = {
        ...
        { 16705, "INV_Gauntlets_32", "=q3=Dreadmist Wraps", "=ds=#s9#, #a1#", "0.03%" },
        { 18699, "INV_Shoulder_27", "=q3=Icy Tomb Spaulders", "=ds=#s3#, #a2#", "0.01%" },
        { 18701, "INV_Jewelry_Ring_24", "=q3=Innervating Band", "=ds=#s13#", "0.01%" },
        { 16722, "INV_Bracer_14", "=q3=Lightforge Bracers", "=ds=#s8#, #a4#", "2.72%" },
        { 16685, "INV_Belt_08", "=q3=Magister's Belt", "=ds=#s8#, #a1#", "0.22%" },
        { 16684, "INV_Gauntlets_17", "=q3=Magister's Gloves", "=ds=#s9#, #a1#", "1.27%" },
        { 18700, "INV_Bracer_07", "=q3=Malefic Bracers", "=ds=#s8#, #a2#", "0.01%" },
        { 16710, "INV_Bracer_07", "=q3=Shadowcraft Bracers", "=ds=#s8#, #a2#", "1.53%" },
        { 18698, "INV_Helmet_41", "=q3=Tattered Leather Hood", "=ds=#s1#, #a2#", "0.01%" },
        { 16716, "INV_Belt_15", "=q3=Wildheart Belt", "=ds=#s8#, #a2#", "1.84%" },
        { 0,"","","" },
        { 0,"","","" },
        { 16254, "INV_Misc_Note_01", "=q3=Formula: Enchant Weapon - Lifestealing", "=ds=#p4# #m14#", "0.93%" },
        { 16255, "INV_Misc_Note_01", "=q2=Formula: Enchant 2H Weapon - Major Spirit", "=ds=#p4# #m14#", "0.88%" },
        { 15773, "INV_Scroll_06", "=q2=Pattern: Wicked Leather Armor", "=ds=#p7# #m14#", "3.03%" },
        { 15776, "INV_Scroll_06", "=q2=Pattern: Runic Leather Armor", "=ds=#p7# #m14#", "1.62%" },
        };
