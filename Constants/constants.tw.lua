...
ATLASLOOT_FACTION_CENARION_EXPEDITION = "塞納里奧遠征軍"; -- The Zandalar Tribe
ATLASLOOT_FACTION_SPOREGGAR = 			"斯博爾加"; -- The Sporeggar
ATLASLOOT_FACTION_KURENAI = 			"The Kurenai"; -- The Kurenai
ATLASLOOT_FACTION_MAGHAR = 				"The Mag'har"; -- The Mag'har
ATLASLOOT_FACTION_TRANQ = 				"The Tranquillien"; -- The Tranquillien
ATLASLOOT_FACTION_HONOR_HOLD = 			"Honor Hold"; -- Honor Hold
ATLASLOOT_FACTION_THRALLMAR = 			"薩爾瑪"; -- Thrallmar
ATLASLOOT_FACTION_SCRYER = 				"The Scryers"; -- The Scryers
ATLASLOOT_FACTION_ALDOR = 				"The Aldor"; -- The Aldor
ATLASLOOT_FACTION_CONSORTIUM = 			"The Consortium"; -- The Consortium
...
ATLASLOOT_ZONE_HELLFIRE_W_PVP_AL = 	"Hellfire Fortifications (聯盟)"; -- Hellfire Fortifications (Alliance)
ATLASLOOT_ZONE_HELLFIRE_W_PVP_HO = 	"Hellfire Fortifications (部落)"; -- Hellfire Fortifications (Horde)
ATLASLOOT_ZONE_ZANGAR = 			"贊加沼澤"; -- Zangarmarsh
ATLASLOOT_ZONE_ZANGAR_W_PVP = 		"Twin Spire Ruins"; -- Twin Spire Ruins
ATLASLOOT_ZONE_TEROKKAR = 			"泰羅卡森林"; -- Terokkar Forest
ATLASLOOT_ZONE_TEROKKAR_W_PVP = 	"Spirit Towers"; -- Spirit Towers
