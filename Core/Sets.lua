...
function AtlasLootRepButton_OnClick(setid, text)
    ...
    getglobal("AtlasLootItemsFrame_NEXT"):Hide();
    getglobal("AtlasLootItemsFrame_PREV"):Hide();
    if (setid=="Darkmoon" or setid=="Timbermaw" or setid=="Sporeggar1" or setid=="Kurenai1" or setid=="Consortium1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, text, AtlasLoot_AnchorFrame);
    elseif (setid=="HonorHold1" or setid=="Thrallmar1" or setid=="Tranquillien1" or setid=="Maghar1" or setid=="Shatar1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, text, AtlasLoot_AnchorFrame);
...
function AtlasLoot_Rep(setid, text)
    ...
    elseif(setid=="Zandalar4") then
        ...
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(setid=="Aldor1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_ALDOR..": "..ATLASLOOT_FRIENDLY.."/"..ATLASLOOT_HONORED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_NEXT").lootpage="Aldor2";
        getglobal("AtlasLootItemsFrame_NEXT"):Show();
    elseif(setid=="Aldor2") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_ALDOR..": "..ATLASLOOT_REVERED.."/"..ATLASLOOT_EXALTED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_PREV").lootpage="Aldor1";
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(setid=="Scryer1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_SCRYER..": "..ATLASLOOT_FRIENDLY.."/"..ATLASLOOT_HONORED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_NEXT").lootpage="Scryer2";
        getglobal("AtlasLootItemsFrame_NEXT"):Show();
    elseif(setid=="Scryer2") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_SCRYER..": "..ATLASLOOT_REVERED.."/"..ATLASLOOT_EXALTED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_PREV").lootpage="Scryer1";
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(setid=="CExpedition1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_CENARION_EXPEDITION..": "..ATLASLOOT_FRIENDLY.."/"..ATLASLOOT_HONORED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_NEXT").lootpage="CExpedition2";
        getglobal("AtlasLootItemsFrame_NEXT"):Show();
    elseif(setid=="CExpedition2") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_CENARION_EXPEDITION..": "..ATLASLOOT_REVERED.."/"..ATLASLOOT_EXALTED, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_PREV").lootpage="CExpedition1";
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(this:GetName()=="AtlasLootItemsFrame_NEXT" or this:GetName()=="AtlasLootItemsFrame_PREV") then
        AtlasLootProfessionsButton_OnClick(this.lootpage);
		
    end
end

function AtlasLootProfessionsButton_OnClick(setid)
	--ChatFrame1:AddMessage("setid="..setid, 255, 255, 255, 0, 0);
    for i = 1, 30, 1 do
        getglobal("AtlasLootMenuItem_"..i):Hide();
    end
    getglobal("AtlasLootItemsFrame_NEXT"):Hide();
    getglobal("AtlasLootItemsFrame_PREV"):Hide();
	if(setid=="EnchantingHead") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_HEAD, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingItems";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingShoulder";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingShoulder") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_SHOULDER, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingHead";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingBack";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingBack") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_BACK, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingShoulder";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingChest";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingChest") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_CHEST, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingBack";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingBracer";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingBracer") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_BRACER, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingChest";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingGloves";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingGloves") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_GLOVES, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingBracer";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingLegs";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingLegs") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_LEGS, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingGloves";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingBoots";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingBoots") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_BOOTS, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingLegs";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingWeapon";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingWeapon") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_WEAPON, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingBoots";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="Enchanting2HWeapon";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="Enchanting2HWeapon") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_2HWEAPON, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingWeapon";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingShield";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingShield") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_SHIELD, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="Enchanting2HWeapon";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingWandsAndRods";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingWandsAndRods") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_WANDSANDRODS, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingShield";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
		getglobal("AtlasLootItemsFrame_NEXT").lootpage="EnchantingItems";
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="EnchantingItems") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENCHANTING..": "..ATLASLOOT_ITEMS, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="EnchantingWandsAndRods";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
	...
	elseif(setid=="TailoringShoulder") then
		...
		getglobal("AtlasLootItemsFrame_NEXT"):Show();
	elseif(setid=="TailoringBack") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_TAILORING..": "..ATLASLOOT_BACK, AtlasLoot_AnchorFrame);
		getglobal("AtlasLootItemsFrame_PREV").lootpage="TailoringShoulder";
		getglobal("AtlasLootItemsFrame_PREV"):Show();
	...
	elseif(setid=="Blacksmithing") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_BLACKSMITHING, AtlasLoot_AnchorFrame);
	elseif(setid=="Engineering") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ENGINEERING, AtlasLoot_AnchorFrame);
	elseif(setid=="Alchemy") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_ALCHEMY, AtlasLoot_AnchorFrame);
	elseif(setid=="Cooking") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_COOKING, AtlasLoot_AnchorFrame);
	elseif(setid=="FirstAid") then
		AtlasLoot_ShowItemsFrame(setid, AtlasLootProfessionsItems, ATLASLOOT_FIRST_AID, AtlasLoot_AnchorFrame);
    elseif(this:GetName()=="AtlasLootItemsFrame_NEXT" or this:GetName()=="AtlasLootItemsFrame_PREV") then
...
function AtlasLootRepMenu()
    ...
    --The Consortium
    AtlasLootMenuItem_10_Name:SetText(ATLASLOOT_FACTION_CONSORTIUM);
    AtlasLootMenuItem_10_Extra:SetText("");
    AtlasLootMenuItem_10_Icon:SetTexture("Interface\\Icons\\INV_Weapon_Shortblade_31");
    AtlasLootMenuItem_10.type="Factions";
    AtlasLootMenuItem_10.lootpage="Consortium1";
    AtlasLootMenuItem_10.text=ATLASLOOT_FACTION_CONSORTIUM;
    ...
    --The Sha'tar
    AtlasLootMenuItem_25_Name:SetText(ATLASLOOT_FACTION_SHATAR);
    AtlasLootMenuItem_25_Extra:SetText("");
    AtlasLootMenuItem_25_Icon:SetTexture("Interface\\Icons\\Spell_Nature_LightningOverload");
    AtlasLootMenuItem_25.type="Factions";
    AtlasLootMenuItem_25.lootpage="Shatar1";
    AtlasLootMenuItem_25.text=ATLASLOOT_FACTION_SHATAR;
...
function AtlasLootProfessionsMenu()
    for i = 1, 30, 1 do
        getglobal("AtlasLootItem_"..i):Hide();
    end
    for i = 1, 30, 1 do
    ...
    getglobal("AtlasLootItemsFrame_PREV"):Hide();
    --Verzauberkunst
    AtlasLootMenuItem_2_Name:SetText(ATLASLOOT_ENCHANTING);
    AtlasLootMenuItem_2_Extra:SetText("");
    AtlasLootMenuItem_2_Icon:SetTexture("Interface\\Icons\\trade_engraving");
    AtlasLootMenuItem_2.type="Professions";
    AtlasLootMenuItem_2.lootpage="EnchantingHead";
    AtlasLootMenuItem_2.text=ATLASLOOT_ENCHANTING;
    AtlasLootMenuItem_2:Show();
    --Lederverarbeitung
    AtlasLootMenuItem_3_Name:SetText(ATLASLOOT_LEATHERWORKING);
    AtlasLootMenuItem_3_Extra:SetText("");
    AtlasLootMenuItem_3_Icon:SetTexture("Interface\\Icons\\inv_misc_armorkit_17");
    AtlasLootMenuItem_3.type="Professions";
    AtlasLootMenuItem_3.lootpage="Leatherworking";
    AtlasLootMenuItem_3.text=ATLASLOOT_LEATHERWORKING;
    AtlasLootMenuItem_3:Show();
    --Ingenieurskunst
    AtlasLootMenuItem_4_Name:SetText(ATLASLOOT_ENGINEERING);
    AtlasLootMenuItem_4_Extra:SetText("");
    AtlasLootMenuItem_4_Icon:SetTexture("Interface\\Icons\\trade_engineering");
    AtlasLootMenuItem_4.type="Professions";
    AtlasLootMenuItem_4.lootpage="Engineering";
    AtlasLootMenuItem_4.text=ATLASLOOT_ENGINEERING;
    AtlasLootMenuItem_4:Show();
	--Kochen
    AtlasLootMenuItem_6_Name:SetText(ATLASLOOT_COOKING);
    AtlasLootMenuItem_6_Extra:SetText("");
    AtlasLootMenuItem_6_Icon:SetTexture("Interface\\Icons\\inv_misc_food_15");
    AtlasLootMenuItem_6.type="Professions";
    AtlasLootMenuItem_6.lootpage="Cooking";
    AtlasLootMenuItem_6.text=ATLASLOOT_COOKING;
    AtlasLootMenuItem_6:Show();
	--Schneidern
    AtlasLootMenuItem_17_Name:SetText(ATLASLOOT_TAILORING);
    AtlasLootMenuItem_17_Extra:SetText("");
    ...
    AtlasLootMenuItem_17:Show();
    --Schmiedekunst
    AtlasLootMenuItem_18_Name:SetText(ATLASLOOT_BLACKSMITHING);
    AtlasLootMenuItem_18_Extra:SetText("");
    AtlasLootMenuItem_18_Icon:SetTexture("Interface\\Icons\\trade_blacksmithing");
    AtlasLootMenuItem_18.type="Professions";
    AtlasLootMenuItem_18.lootpage="Blacksmithing";
    AtlasLootMenuItem_18.text=ATLASLOOT_BLACKSMITHING;
    AtlasLootMenuItem_18:Show();
    --Alchimie
    AtlasLootMenuItem_19_Name:SetText(ATLASLOOT_ALCHEMY);
    AtlasLootMenuItem_19_Extra:SetText("");
    AtlasLootMenuItem_19_Icon:SetTexture("Interface\\Icons\\trade_alchemy");
    AtlasLootMenuItem_19.type="Professions";
    AtlasLootMenuItem_19.lootpage="Alchemy";
    AtlasLootMenuItem_19.text=ATLASLOOT_ALCHEMY;
    AtlasLootMenuItem_19:Show();
    --Erste Hilfe
    AtlasLootMenuItem_21_Name:SetText(ATLASLOOT_FIRST_AID);
    AtlasLootMenuItem_21_Extra:SetText("");
    AtlasLootMenuItem_21_Icon:SetTexture("Interface\\Icons\\spell_holy_sealofsacrifice");
    AtlasLootMenuItem_21.type="Professions";
    AtlasLootMenuItem_21.lootpage="FirstAid";
    AtlasLootMenuItem_21.text=ATLASLOOT_FIRST_AID;
    AtlasLootMenuItem_21:Show();
    AtlasLoot_BossName:SetText("|cffFFFFFF"..ATLASLOOT_PANEL_BUTTON_PROFESSIONS);
    AtlasLoot_SetItemInfoFrame(AtlasLoot_AnchorFrame);
end
...
function AtlasLootMenuItem_OnClick()
    ...
    elseif this.type=="Professions" then
        AtlasLootProfessionsButton_OnClick(this.lootpage);		
